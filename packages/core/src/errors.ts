export const ErrorCode = {
  ...
  // OperationRuntime persistence, recovery and user-level rollback (Batch 1)
  ...
  // Migration registry and durable upgrade checkpoints (Batch 5)
  MIGRATION_INVALID: 'MIGRATION_INVALID',
  // Repository synchronization (multi-device conflict handling)
