...
describe('ErrorCode', () => {
  it('maps every standard code to its string value', () => {
    const expected: Record<string, string> = {
      ...
      OPERATION_LOCK_STALE: 'OPERATION_LOCK_STALE',
      OPERATION_JOURNAL_INVALID: 'OPERATION_JOURNAL_INVALID',
      OPERATION_JOURNAL_INCOMPLETE: 'OPERATION_JOURNAL_INCOMPLETE',
      ...
      SYNC_GIT_MERGE_IN_PROGRESS: 'SYNC_GIT_MERGE_IN_PROGRESS',
